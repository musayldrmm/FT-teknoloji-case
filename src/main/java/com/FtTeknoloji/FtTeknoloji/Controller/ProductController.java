...
public class ProductController {
    ...
    public List<Product> expredationBefore(@RequestBody CheckExpredation checkExpredation){
        Date date = checkExpredation.getDate();
        return productService.expredationBefore(date);
    }
    @PostMapping("/list-after-date")
    public List<Product> expredationAfter(@RequestBody CheckExpredation checkExpredation){
        Date date = checkExpredation.getDate();
